        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="grid flex-1 text-left text-sm leading-tight">
                ...
                <span className="truncate text-xs">${activeAccount.balance.toLocaleString()}</span>
              </div>
          ...
          >
            ...
            {accounts.map((account, index) => (
              <DropdownMenuItem key={account.name} onClick={() => setActiveAccount(account)} className="gap-2 p-2">
